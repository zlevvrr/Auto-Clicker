...
Features
⚫ Automates mouse clicks with a single configurable HotKey
⚫ Supports single or double clicks and left, right, or middle mouse buttons
⚫ Records click sequences on different screen locations for repeat use
⚫ Customizable click intervals from milliseconds up to hours
⚫ Option to click continuously or stop after a set number of clicks
⚫ Compatible with Windows Vista, Windows 7, and 64-bit systems
⚫ Available on Android (mainly for Chromebooks) and Mac OS platforms
⚫ Chrome browser extension available with limited compatibility



<img width="367" height="274" alt="image" src="https://github.com/user-attachments/assets/b5253704-d021-4742-a842-d8d8b5e2e1d9" />
<img width="367" height="274" alt="image" src="https://github.com/user-attachments/assets/09dcee31-0a28-47ba-9dd7-b3174dcb9739" />
